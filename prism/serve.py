...
<style>
  ...
  *{-webkit-font-smoothing:antialiased;text-rendering:optimizeLegibility}
  ...
  /* ── 버튼 프레즌스 강화(전 페이지 원칙): 텍스트 버튼 금지 → 박스/아이콘, 라벨 굵기·대비 상향 ── */
  ...
  /* 은은한 버튼(secondary·ghost·outline)도 쉼 상태에서 버튼임이 보이게: 면·경계 대비 확보 */
  .ds-btn--secondary,.ds-btn--ghost{background:var(--ds-surface-white);border-color:var(--ds-hairline);
    box-shadow:0 1px 2px rgba(16,24,40,.05),inset 0 1px 0 rgba(255,255,255,.6)}
  .ds-btn--secondary:hover,.ds-btn--ghost:hover{border-color:var(--ds-border-input-hover);background:var(--ds-primary-tint);color:var(--ds-primary-deep)}
  .ds-btn--outline{border-color:var(--ds-border-input);box-shadow:0 1px 2px rgba(16,24,40,.04)}

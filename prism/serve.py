...
<style>
  ...
  *{-webkit-font-smoothing:antialiased;text-rendering:optimizeLegibility}
  ...
  /* EmptyState(모듈 빈 상태) — DS 갭, 토큰으로 구성 */
...
<div x-data="prismApp()" class="shell" data-theme="dark">
  ...
  <main class="pane">
    ...
    <div class="pbody center">
      ...
      <div x-show="mod === 'dash'" x-cloak class="ds-dark ds-pilot mx-auto max-w-4xl">
        ...
        <div x-show="dashData && dashData.n" class="space-y-4">
          ...
          <div class="ds-card"><div style="display:flex;align-items:center;gap:24px">
            ...
            <div style="min-width:0;flex:1">
              <div class="ds-eyebrow" style="margin-bottom:8px">인텐트 분포</div>
          ...
          <div class="ds-card">
            <div class="ds-eyebrow" style="margin-bottom:10px">콘텐츠 카테고리 분포 · 상위</div>

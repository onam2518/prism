...
INTENT_VALUE_DEFS = {
    ...
    "정책·행정": "정책·사업 소개 + 법안 통과 + 행정 발표 통합 · 주최·발표 주체가 정부·지자체라는 이유로 부여하지 않는다 — 기사의 주제가 행정 자체일 때만 부여하고, 정부기관이 연 행사·전시 소식은 '뉴스·소식' · 기업 홍보성 기사에도 부여하지 않는다",
    ...
    "뉴스·소식": "신제품·동향·공식 발표 등 소식 전달 · 정부·지자체가 주최한 행사·전시라도 기사의 주제가 행사 소식이면 이 값('정책·행정' 아님) · 미부여: 영상 클립·하이라이트가 전달의 주인 것('클립·하이라이트')", "칼럼": "화자 관점이 강한 해설·주장(사설 포함 · 사설·칼럼 통합 운영)",
    ...
    "정보 공유": "알아두면 좋은 정보·팁·노하우를 나누는 것 · 경계: 단계별 절차 안내는 '가이드·튜토리얼', 독자가 바로 따라 할 방법·조건은 '실용 정보' · 같은 근거로 셋을 중복 부여하지 않는다", "의견·토론": "특정 이슈에 대한 의견 개진과 토론",
